...
// LATEST VERSION: https://github.com/acdha/fiddler-scripts/blob/master/CustomRules.js
...
class Handlers
{
    ...
    RulesStringValue(13,"&Opera", "Opera/9.80 (Windows NT 6.1; U; en) Presto/2.10.229 Version/11.61")
    ...
    RulesStringValue(16,"&Firefox 14", "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:14.0) Gecko/20100101 Firefox/14.0")
    ...
    RulesStringValue(18,"Chrome", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.5 (KHTML, like Gecko) Chrome/19.0.1084.56 Safari/536.5")
    RulesStringValue(19,"GoogleBot Crawler", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)")
    RulesStringValue(20,"Kindle Fire (Silk)", "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_3; en-us; Silk/1.0.22.79_10013310) AppleWebKit/533.16 (KHTML, like Gecko) Version/5.0 Safari/533.16 Silk-Accelerated=true")
    ...
    // Cause Fiddler to delay HTTP traffic related to web fonts
    public static RulesOption("Simulate Slow Web Fonts", "Per&formance")
    var m_SimulateSlowFonts: boolean = false;
